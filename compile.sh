rm -rf ./out
javac -d out/modules --module-source-path java java/de.arkadi.hello.good/de/arkadi/hello/good/* -Xlint
javac -d out/modules --module-source-path java java/de.arkadi.hello.bad/de/arkadi/hello/bad/* -Xlint
javac -d out/modules --module-source-path java java/de.arkadi.hello.caller/de/arkadi/hello/caller/* -Xlint
javac -d out/modules --module-source-path java java/de.arkadi.hello.starter/de/arkadi/hello/starter/* -Xlint
